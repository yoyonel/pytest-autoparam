...
with open("src/pytest_autoparam/version.py") as fp:
...
class PostInstallCommand(install):  # type: ignore
    ...
    def run(self) -> None:
        ...
        try:
            data_directory = os.path.expanduser("~/.local/share/pytest-autoparam")
...
setup(
    name="pytest-autoparam",
    version=version,
    description="Project to deploy pytest-autoparam",
    author="Lionel ATTY",
    author_email="yoyonel@hotmail.com",
    license="GNU General Public License v3",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/yoyonel/pytest-autoparam",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={"pytest_autoparam": ["py.typed"]},
    ...
    entry_points="""
        [console_scripts]
        pytest_autoparam=pytest_autoparam.entrypoints.cli:cli
    """,
